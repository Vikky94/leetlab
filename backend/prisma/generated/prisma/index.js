...
exports.Prisma.UserScalarFieldEnum = {
  ...
  forgotPassworddToken: 'forgotPassworddToken',
  forgotPassworddTokenExpiry: 'forgotPassworddTokenExpiry'
};
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\leetlab\\backend\\prisma\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "sourceFilePath": "C:\\leetlab\\backend\\prisma\\schema\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "enum Difficulty {\n  EASY\n  MEDIUM\n  HARD\n}\n\nmodel Problem {\n  id          String     @id @default(uuid())\n  title       String\n  description String\n  difficulty  Difficulty\n  tags        String[] // [\"tag1\", \"tag2\", \"tag3\"]\n  userId      String\n  examples    Json\n  constraints String\n  hints       String?\n  editorial   String?\n\n  testcases          Json // \n  codeSnippets       Json\n  referenceSolutions Json\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  //  Relationship\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n}\n\nenum UserRole {\n  ADMIN\n  USER\n}\n\nmodel User {\n  id                           String    @id @default(uuid())\n  firstName                    String?\n  lastName                     String?\n  username                     String    @unique\n  email                        String    @unique\n  image                        String?\n  role                         UserRole  @default(USER)\n  password                     String\n  createdAt                    DateTime  @default(now())\n  updatedAt                    DateTime  @updatedAt\n  emailVerificationToken       String?\n  emailVerificationTokenExpiry DateTime?\n  forgotPassworddToken         String?\n  forgotPassworddTokenExpiry   DateTime?\n  problems                     Problem[]\n}\n\n// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider        = \"prisma-client-js\"\n  output          = \"../generated/prisma\"\n  previewFeatures = [\"prismaSchemaFolder\"]\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n",
  "inlineSchemaHash": "a8f0fe35bbb08c98f907b66550eaf540a39a0feb49bdb760d6842d6c995e7b77",
  "copyEngine": true
}
